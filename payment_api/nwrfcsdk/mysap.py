...
# call back
@app.get("/kbank/callback/notify/")
def notify():
        return {"status": "success", "data": "callback success!"}

@app.get("/ktb/callback/success/")
def ktb_success():
        return {"status": "success", "data": "success!"}
    
@app.get("/ktb/callback/fail/")
def ktb_fail():
        return {"status": "success", "data": "fail!"}
    
@app.get("/ktb/callback/cancel/")
def ktb_cancel():
        return {"status": "success", "data": "cancel!"}
